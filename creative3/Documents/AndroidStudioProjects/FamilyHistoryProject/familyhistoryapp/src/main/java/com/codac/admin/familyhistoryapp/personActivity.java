...
public class personActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final peopleAdapter pplAdapter = new peopleAdapter(this, personListHeaders, personChildList);
    ...
    private void startPersonActivity(person prsn) {
        Intent intent = new Intent(this, personActivity.class);
        intent.putExtra("personID",  prsn.getPersonID());
        startActivity(intent);
    }

    private void startMapActivity(event evnt) {
