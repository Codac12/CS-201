...
public class ExampleUnitTest {
    ...
    public void setup()
    {
        ...
        String jsonPrsn="{\n" +
                "      \"userName\": \"Codac\",\n" +
                "      \"password\": \"codac\",\n" +
                "      \"email\": \"codac@live.com\",\n" +
                "      \"firstName\": \"Cody\",\n" +
                "      \"lastName\": \"Kesler\",\n" +
                "      \"gender\": \"male\",\n" +
                "      \"personID\": \"cod_kesler\"\n" +
                "    }";
        String jsonPrsns = "\"persons\": [\n" +
                "    {\n" +
    ...
    private boolean testPersonEventsMap() {
        ...
        events = m.getPersonEvents().get("tauna_kesler");
        for(event evnt : events)
        {
            if(!evnt.getPersonID().equals("tauna_kesler"))
                return false;
        }
    ...
    private boolean testPersonMap() {
        if(m.getPeople().get("cod_kelser").getPersonID().equals("cod_kesler"))
        {
            if(m.getPeople().get("matt_kelser").getPersonID().equals("matt_kesler"))
            {
                if(m.getPeople().get("orson_kelser").getPersonID().equals("orson_kesler"))
                {
                    return true;
                }
            }
